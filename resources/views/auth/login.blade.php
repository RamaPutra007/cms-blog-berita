<x-guest-layout>
    ...
    <div
        class="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-100 via-blue-50 to-indigo-100 p-6">
            ...
            <div
                ...
                <div>
                    ...
                    <a href="{{ route('home') }}" class="group">
                        ...
                        <h1 class="text-3xl font-bold group-hover:text-blue-200 transition">
                            Sudiang Info
                        </h1>
                ...
                <div>
                    ...
                    <p class="mt-6 text-lg text-blue-100 leading-relaxed">
                        ...
                        kategori dan data website dengan aman.
                        ...
                        <div>
                            ...
                            <div class="relative mt-2">
                                ...
                                <input type="password" name="password" placeholder="••••••••"
                                    class="w-full h-14 pl-12 rounded-xl border-gray-300 focus:ring-blue-500 focus:border-blue-500 @error('password') border-red-500 @enderror"
                                    required>
                            </div>

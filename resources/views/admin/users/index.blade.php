                            ...
                            <tr class="hover:bg-blue-50 transition">
                                ...
                                <td class="px-6 py-5">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div
                                            class="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-blue-700
text-white flex items-center justify-center font-bold text-lg">
                                ...
                                <td class="px-6 py-5">
                                    ...
                                    @else
                                        <span
                                            class="px-4 py-2 rounded-full bg-blue-100 text-blue-700 text-sm font-semibold">
                                ...
                                <td class="px-6 py-5">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <a href="{{ route('admin.users.show', $user) }}"
                                            class="w-10 h-10 rounded-xl bg-green-100 text-green-700
flex items-center justify-center hover:bg-green-600 hover:text-white transition">
                                        ...
                                        <a href="{{ route('admin.users.edit', $user) }}"
                                            class="w-10 h-10 rounded-xl bg-yellow-100 text-yellow-700
flex items-center justify-center hover:bg-yellow-500 hover:text-white transition">
                                        ...
                                        <form action="{{ route('admin.users.destroy', $user) }}" method="POST"
                                            ...
                                            <button
                                                class="w-10 h-10 rounded-xl bg-red-100 text-red-700
            ...
            @forelse($users as $user)
                <div class="bg-white rounded-3xl shadow-lg p-5 hover:shadow-xl transition">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div
                            class="w-14 h-14 rounded-full bg-gradient-to-br from-blue-500 to-blue-700
text-white flex items-center justify-center font-bold text-xl">
                    ...
                    <div class="grid grid-cols-3 gap-3 mt-5">
                        ...
                        <a href="{{ route('admin.users.show', $user) }}"
                            class="py-3 text-center rounded-xl bg-green-100 text-green-700 hover:bg-green-600 hover:text-white transition">
                        ...
                        <a href="{{ route('admin.users.edit', $user) }}"
                            class="py-3 text-center rounded-xl bg-yellow-100 text-yellow-700 hover:bg-yellow-500 hover:text-white transition">
